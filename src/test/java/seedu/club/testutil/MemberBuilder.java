...
public class MemberBuilder {
     ...
     */
    public MemberBuilder withEventRoles(String event, String ... roles) {
        Name eventName = new Name(event);
        this.eventRoles.addAll(SampleDataUtil.getEventRoleSet(eventName, roles));
        return this;
    }
